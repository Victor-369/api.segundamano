 ...
 * -------------------------------------------------------------*/
    ...
    define('APP_NAME','API SegundaMano (Demo)');
    
    // tipo de aplicación
    define('APP_TYPE', 'API'); // puede ser APP o API
 ...
 * -------------------------------------------------------------*/
    ...
    define('DB_HOST','api.segundamano');  // host
    define('DB_USER','root');         // usuario
    define('DB_PASS','');             // password
    define('DB_NAME','segundamano');    // base de datos
